      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'assets/images/umkm2.png'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
              <h2>Berita UMKM Semarang</h2>
		   					<h3><p>Semangat</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'assets/images/berita.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
              <h2>Berita UMKM Semarang</h2>
		   					<h3><p>Semangat</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'assets/images/UMKM.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
              <h2>Berita UMKM Semarang</h2>
		   					<h3><p>Semangat</p></h3>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo base_url().'assets/images/umkm1.jpg'?>" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
              <h2>Berita UMKM Semarang</h2>
		   					<h3><p>Semangat</p></h3>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>NEWS UMKM  SEMARANG</h3>
          <p>BERITA SEPUTAR EVENT UMKM
			</p>
        </header>
...
<!--            
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>UMKM SEMARANG</strong>. All Rights Reserved
      </div>
