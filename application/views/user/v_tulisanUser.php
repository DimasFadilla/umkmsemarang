            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><button href="<?php echo base_url('Home'); ?>"class="btn"><img src="<?php echo base_url().'assets/images/'.$tulisan_gambar;?>" style="width:90px;"></button></td>
                ...
                <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'user/tulisan/keterangan_status/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
