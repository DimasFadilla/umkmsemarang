...
class mahasiswa extends CI_Controller
{
	...
	function kirim_pesan()
	{
		...
		$namalokasi = htmlspecialchars($this->input->post('namalokasi', TRUE), ENT_QUOTES);
		$latitude = htmlspecialchars($this->input->post('latitude', TRUE), ENT_QUOTES);
		$longtitude = htmlspecialchars($this->input->post('longtitude', TRUE), ENT_QUOTES);
		$this->m_mahasiswa->kirim_pesan($nim, $nama, $email, $pass, $namalokasi, $latitude, $longtitude);
	...
	{
		$x['data'] = $this->m_mahasiswa->get_all_mahasiswa();
		$this->load->view('admin/v_mapsuser', $x);
	}
}
